...
function register_GMSC_plugin_settings() {
	...
	//end of地圖設定
	//begin of運費設定
	register_setting( 'google_map_base-group', 'plugin_google_map_counttype_setting' );
	...
	register_setting( 'google_map_base-group', 'plugin_google_map_extra_time_price' );
	register_setting( 'google_map_base-group', 'plugin_google_map_extra_time_distance' );
	register_setting( 'google_map_base-group', 'plugin_google_map_base_time_price' );
	register_setting( 'google_map_base-group', 'plugin_google_map_base_time_distance' );
	//end of運費設定
	...
	<div id="tab-01">
		<div class="wrap">
			...
			<form method="post" action="options.php">
				...
				<br>
				<span><a href="https://console.cloud.google.com/google/maps-apis/start">點選此處申請google map API Key</a></span>
				<br>
				<br>
